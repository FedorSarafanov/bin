...
im = cv2.imread('/home/lab/bin/screen.png')
tmp = cv2.imread('/home/lab/bin/find.png')
...
if (altconfidence > 99) or ((confidence > 97) and (altconfidence > 93)) or ((confidence > 95.7) and (altconfidence > 96.3)):
   ...
   subprocess.check_output(['bash','-c', "bash /home/lab/bin/xdo2.sh "+str(topleftx+15)+" "+str(toplefty+15)])
   if (len(sys.argv) > 3):
